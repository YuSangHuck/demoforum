...
import com.demo.demoforum.domain.auth.entity.AuthRole1;
...
public class MemberSecurityService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if ("admin".equals(username)) {
            authorities.add(new SimpleGrantedAuthority(AuthRole1.ADMIN.getValue()));
        } else {
            authorities.add(new SimpleGrantedAuthority(AuthRole1.USER.getValue()));
        }
