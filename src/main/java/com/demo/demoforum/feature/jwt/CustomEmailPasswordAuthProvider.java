...
import com.demo.demoforum.exception.MemberExceptionType;
import com.demo.demoforum.feature.member.MemberSecurityJwtService;
...
public class CustomEmailPasswordAuthProvider implements AuthenticationProvider {
    ...
    protected final UserDetails retrieveUser(String username) throws BizException {
        try {
            UserDetails loadedUser = memberSecurityJwtService.loadUserByUsername(username);
            if (loadedUser == null) {
